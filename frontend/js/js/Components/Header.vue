...
console.log("🛠️ Incoming props:", props);
</script>
  ...
  <header
    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 flex items-center justify-between h-16">
      ...
      <nav class="hidden md:flex items-center space-x-6">
        ...
        <Link href="/contact"
              class="text-gray-700 dark:text-gray-300 hover:text-pink-500 dark:hover:text-pink-400 transition">Contact
        </Link>
        <Link v-if="user" href="/dashboard"
              class="text-gray-700 dark:text-gray-300 hover:text-pink-500 dark:hover:text-pink-400 transition">Dashboard
        </Link>
    ...
    <div v-if="mobileMenuOpen" class="md:hidden px-4 pb-4 space-y-2 bg-white dark:bg-gray-900 shadow">
      ...
      <Link v-if="user" href="/dashboard"
            class="block text-gray-700 dark:text-gray-300 hover:text-pink-500 dark:hover:text-pink-400">Dashboard a <span>{{ user }}</span>
      </Link>
      ...
      <Link v-if="user" href="/profile/edit/"
             class="block text-gray-700 dark:text-gray-300 hover:text-pink-500 dark:hover:text-pink-400">
        Profile
      </Link>
      <button v-if="user" @click="logout"
